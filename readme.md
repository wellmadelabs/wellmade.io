<h1>Customization Notes</h1>
<ul>
  <li>Add Emotion.js for styling</li>
  <li>Add Typography.js for fonts</li>
  <li>Update filesystem for images in gatsby-config</li>
  <li>Delete content directory</li>
  <li>Delete about page</li>
  <li>Import typographies in gatsby-browser</li>
  <li>Clear graphql out of home page</li>
  <li>Use `<PageMeta>` instead of `<Head>`</li>
  <li></li>
  <li></li>
</ul>
<p align="center">
